...
# eval <<END has eval "..."
if (eval Char::KPS9566::escape <<END) {
eval Char::KPS9566::escape " if ('アソ' !~ /A/) { return 1 } else { return 0 } "
END
...
if (eval Char::KPS9566::escape <<END) {
eval Char::KPS9566::escape qq{ if ('アソ' !~ /A/) { return 1 } else { return 0 } }
END
...
# eval <<END has eval '...'
if (eval Char::KPS9566::escape <<END) {
eval Char::KPS9566::escape ' if (qq{アソ} !~ /A/) { return 1 } else { return 0 } '
END
...
# eval <<END has eval q{...}
if (eval Char::KPS9566::escape <<END) {
eval Char::KPS9566::escape q{ if ('アソ' !~ /A/) { return 1 } else { return 0 } }
END
