...
sub import {
    ...
    if (Char::Ekps9566::e("$filename.e")) {
        if (exists $ENV{'SJIS_DEBUG'}) {
            ...
            my $mtime_filter = (Char::Ekps9566::stat(__FILE__     ))[9];
            my $mtime_source = (Char::Ekps9566::stat($filename    ))[9];
            my $mtime_escape = (Char::Ekps9566::stat("$filename.e"))[9];
...
import of Char/Ekps9566.pm works well.
...
=item * Returns Next Character
  ...
  If you import getc "use Char::KPS9566 qw(getc);", getc of your script will be rewritten
  in Char::KPS9566::getc. Char::KPS9566::getc is not compatible with getc of JPerl.
...
=item * Length by KPS9566 Character
  ...
  of the scalar value $string. If $string is omitted, it returns the Char::KPS9566::length
  of $_.
...
=item * Substr by KPS9566 Character
  ...
  If Perl version 5.14 or later, you can use the Char::KPS9566::substr() subroutine as an
...
=item * Rindex by KPS9566 Character
  ...
  This subroutine works just like Char::KPS9566::index except that it returns the character
...
=item * Filename Globbing
  ...
  This operator is implemented via the Char::Ekps9566::glob() subroutine. See Char::Ekps9566::glob
  of Char/Ekps9566.pm for details.
...
=head1 Un-Escaping bytes::* Subroutines (Char/KPS9566.pm provides)

Char/KPS9566.pm removes 'bytes::' at head of subroutine name.
...
If Perl version is older than 5.14, Char::KPS9566::substr differs from CORE::substr, and
...
exist at time of be written this document and JPerl did exist.
                        ...
                        (a)     (b)     (c)     (d)     (e)
                                      JPerl,japerl    Encode,Char::KPS9566
      +--------------+-------+-------+-------+-------+-------+
      | data         |  Old  |  Old  |  New  |  Old  |  New  |
      +--------------+-------+-------+-------+-------+-------+
      | script       |  Old  |      Old      |      New      |
