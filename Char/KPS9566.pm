...
10% everything else. But this "text" means US-ASCII text, and popular KPS9566
...
Perl3 or later can treat KPS9566.

Perl is designed to make the easy jobs easy, without making the hard jobs
impossible. Char::KPS9566 software is Perl program designed to make the "easy jobs easy".
...
=item * Handles Raw KPS9566, Doesn't use UTF8 flag like JPerl
...
Definitions in Char/Ekps9566.pm.
  ...
  ${Char::Ekps9566::not_space}      qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE\x09\x0A\x0B\x0C\x0D\x20])}
...
It has already been achieved by KPS9566 designed for combining with
...
Contrasting is Encode module and describing "use Char::KPS9566;" on this software,
