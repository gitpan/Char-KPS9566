...
if (($] >= 5.010001) or
    ...
    if (__PACKAGE__ =~ / \b Egb18030 \z/oxms) {
        ${Char::Ekps9566::q_char_SADAHIRO_Tomoyuki_2002_01_17} = qr{.*?[^\x30-\x39\x81-\xFE](?:[\x30-\x39]|[\x81-\xFE][\x30-\x39][\x81-\xFE][\x30-\x39]|[\x81-\xFE]{2})*?}oxms;
    }
...
sub Char::Ekps9566::filetest {
    ...
    unless (eval qq{Char::Ekps9566::$filetest(\$file)}) {
        return '';
    }
...
sub Char::Ekps9566::filetest_ {
    ...
    unless (eval qq{Char::Ekps9566::${filetest}_}) {
        return '';
    }
    for my $filetest (CORE::reverse @_) {
        unless (eval qq{ $filetest _ }) {
...
This module is a run-time routines of the Char/KPS9566.pm.
Because the Char/KPS9566.pm automatically uses this module, you need not use directly.
...
=item Transliteration
  ...
  This function scans a KPS9566 string character by character and replaces all
...
=item Chop string
  ...
  character chopped. The Char::Ekps9566::chop function is used primary to remove the newline
...
=item Reverse index string
  ...
  This function works just like Char::Ekps9566::index except that it returns the byte
...
=item Lower case string
  ...
  This function returns a lowercased version of KPS9566 $string (or $_, if
  $string is omitted). This is the internal function implementing the \L escape
  in double-quoted strings.

  You can use the Char::Ekps9566::fc function for case-insensitive comparisons via Char::KPS9566
  software.
...
=item Lower case first character of string
  ...
  This function returns a version of KPS9566 $string with the first character
...
=item Upper case string
  ...
  This function returns an uppercased version of KPS9566 $string (or $_, if
...
=item Fold case string
  ...
  New to Char::KPS9566 software, this function returns the full Unicode-like casefold of
  KPS9566 $string (or $_, if omitted). This is the internal function implementing
...
=item File test function Char::Ekps9566::X
...
=item Filename expansion (globbing)
  ...
  The Char::Ekps9566::glob function grandfathers the use of whitespace to separate multiple
...
=item Statistics about file
  ...
  the last Char::Ekps9566::stat, Char::Ekps9566::lstat, or Char::Ekps9566::stat-based file test function
