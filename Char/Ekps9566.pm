...
#
package Char::Ekps9566;
######################################################################
#
# Char::Ekps9566 - Run-time routines for Char/KPS9566.pm
#
...
BEGIN {
    ...
    sub qualify ($;$) {
        my ($name) = @_;
        if (!ref($name) && (Char::Ekps9566::index($name, '::') == -1) && (Char::Ekps9566::index($name, "'") == -1)) {
            my $pkg;
...
sub import {
    ...
    if ($^O =~ /\A (?: MSWin32 | NetWare | symbian | dos ) \z/oxms) {
        ...
        for (@ARGV) {
            ...
            # has space
            if (/\A (?:$q_char)*? [ ] /oxms) {
                if (my @glob = Char::Ekps9566::glob(qq{"$_"})) {
                    push @argv, @glob;
                }
                else {
                    push @argv, $_;
            ...
            # has wildcard metachar
                ...
                if (my @glob = Char::Ekps9566::glob($_)) {
                    push @argv, @glob;
                }
                else {
                    push @argv, $_;
...
#
sub unimport {}
sub Char::Ekps9566::split(;$$$);
sub Char::Ekps9566::tr($$$$;$);
sub Char::Ekps9566::chop(@);
sub Char::Ekps9566::index($$;$);
sub Char::Ekps9566::rindex($$;$);
sub Char::Ekps9566::lcfirst(@);
sub Char::Ekps9566::lcfirst_();
sub Char::Ekps9566::lc(@);
sub Char::Ekps9566::lc_();
sub Char::Ekps9566::ucfirst(@);
sub Char::Ekps9566::ucfirst_();
sub Char::Ekps9566::uc(@);
sub Char::Ekps9566::uc_();
sub Char::Ekps9566::fc(@);
sub Char::Ekps9566::fc_();
sub Char::Ekps9566::ignorecase;
sub Char::Ekps9566::classic_character_class;
sub Char::Ekps9566::capture;
sub Char::Ekps9566::chr(;$);
sub Char::Ekps9566::chr_();
sub Char::Ekps9566::filetest;
sub Char::Ekps9566::r(;*@);
sub Char::Ekps9566::w(;*@);
sub Char::Ekps9566::x(;*@);
sub Char::Ekps9566::o(;*@);
...
sub Char::Ekps9566::A(;*@);
sub Char::Ekps9566::C(;*@);
sub Char::Ekps9566::filetest_;
sub Char::Ekps9566::r_();
sub Char::Ekps9566::w_();
sub Char::Ekps9566::x_();
sub Char::Ekps9566::o_();
sub Char::Ekps9566::R_();
sub Char::Ekps9566::W_();
sub Char::Ekps9566::X_();
sub Char::Ekps9566::O_();
sub Char::Ekps9566::e_();
sub Char::Ekps9566::z_();
sub Char::Ekps9566::s_();
sub Char::Ekps9566::f_();
sub Char::Ekps9566::d_();
sub Char::Ekps9566::l_();
sub Char::Ekps9566::p_();
sub Char::Ekps9566::S_();
sub Char::Ekps9566::b_();
sub Char::Ekps9566::c_();
sub Char::Ekps9566::u_();
sub Char::Ekps9566::g_();
sub Char::Ekps9566::k_();
sub Char::Ekps9566::T_();
sub Char::Ekps9566::B_();
sub Char::Ekps9566::M_();
sub Char::Ekps9566::A_();
sub Char::Ekps9566::C_();
sub Char::Ekps9566::glob($);
sub Char::Ekps9566::glob_();
sub Char::Ekps9566::lstat(*);
sub Char::Ekps9566::lstat_();
sub Char::Ekps9566::opendir(*$);
sub Char::Ekps9566::stat(*);
sub Char::Ekps9566::stat_();
sub Char::Ekps9566::unlink(@);
sub Char::Ekps9566::chdir(;$);
sub Char::Ekps9566::do($);
sub Char::Ekps9566::require(;$);
sub Char::Ekps9566::telldir(*);

sub Char::KPS9566::ord(;$);
sub Char::KPS9566::ord_();
sub Char::KPS9566::reverse(@);
sub Char::KPS9566::getc(;*@);
sub Char::KPS9566::length(;$);
sub Char::KPS9566::substr($$;$$);
sub Char::KPS9566::index($$;$);
sub Char::KPS9566::rindex($$;$);
sub Char::KPS9566::escape(;$);
...
${Char::Ekps9566::anchor}      = qr{\G(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE])*?}oxms;
BEGIN { CORE::eval q{ use vars qw(
...
if (($] >= 5.010001) or
    ...
    # other encoding
        ...
        ${Char::Ekps9566::q_char_SADAHIRO_Tomoyuki_2002_01_17} = qr{.*?[$sbcs](?:$tbcs_1st[^$sbcs]{2})*?}oxms;
    }

    ${Char::Ekps9566::anchor_SADAHIRO_Tomoyuki_2002_01_17} =
    qr{\G(?(?=.{0,32766}\z)(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE])*?|(?(?=[$sbcs]+\z).*?|(?:${Char::Ekps9566::q_char_SADAHIRO_Tomoyuki_2002_01_17})))}oxms;
#   qr{
#      \G # (1), (2)
#        (? # (3)
#          (?=.{0,32766}\z) # (4)
...
#                                                                                      (?(?=[$sbcs]+\z) # (6)
#                                                                                                      .*?| #(7)
#                                                                                                          (?:${Char::Ekps9566::q_char_SADAHIRO_Tomoyuki_2002_01_17}) # (8)
#                                                                                                                                                           ))}oxms;

    # avoid: Complex regular subexpression recursion limit (32766) exceeded at here.
    local $^W = 0;

    if (((('A' x 32768).'B') !~ / ${Char::Ekps9566::anchor}                              B /oxms) and
        ((('A' x 32768).'B') =~ / ${Char::Ekps9566::anchor_SADAHIRO_Tomoyuki_2002_01_17} B /oxms)
    ) {
        ${Char::Ekps9566::anchor} = ${Char::Ekps9566::anchor_SADAHIRO_Tomoyuki_2002_01_17};
    }
    else {
        undef ${Char::Ekps9566::q_char_SADAHIRO_Tomoyuki_2002_01_17};
    }
}
...
${Char::Ekps9566::dot}         = qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE\x0A])};
${Char::Ekps9566::dot_s}       = qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE])};
${Char::Ekps9566::eD}          = qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE0-9])};
...
# ${Char::Ekps9566::eS}        = qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE\x09\x0A    \x0C\x0D\x20])};
# ${Char::Ekps9566::eS}        = qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE\x09\x0A\x0B\x0C\x0D\x20])};
${Char::Ekps9566::eS}          = qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE\s])};

${Char::Ekps9566::eW}          = qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE0-9A-Z_a-z])};
${Char::Ekps9566::eH}          = qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE\x09\x20])};
${Char::Ekps9566::eV}          = qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE\x0A\x0B\x0C\x0D])};
${Char::Ekps9566::eR}          = qr{(?:\x0D\x0A|[\x0A\x0D])};
${Char::Ekps9566::eN}          = qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE\x0A])};
${Char::Ekps9566::not_alnum}   = qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE\x30-\x39\x41-\x5A\x61-\x7A])};
${Char::Ekps9566::not_alpha}   = qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE\x41-\x5A\x61-\x7A])};
${Char::Ekps9566::not_ascii}   = qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE\x00-\x7F])};
${Char::Ekps9566::not_blank}   = qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE\x09\x20])};
${Char::Ekps9566::not_cntrl}   = qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE\x00-\x1F\x7F])};
${Char::Ekps9566::not_digit}   = qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE\x30-\x39])};
${Char::Ekps9566::not_graph}   = qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE\x21-\x7F])};
${Char::Ekps9566::not_lower}   = qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE\x61-\x7A])};
${Char::Ekps9566::not_lower_i} = qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE])};
${Char::Ekps9566::not_print}   = qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE\x20-\x7F])};
${Char::Ekps9566::not_punct}   = qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE\x21-\x2F\x3A-\x3F\x40\x5B-\x5F\x60\x7B-\x7E])};
${Char::Ekps9566::not_space}   = qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE\s\x0B])};
${Char::Ekps9566::not_upper}   = qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE\x41-\x5A])};
${Char::Ekps9566::not_upper_i} = qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE])};
${Char::Ekps9566::not_word}    = qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE\x30-\x39\x41-\x5A\x5F\x61-\x7A])};
${Char::Ekps9566::not_xdigit}  = qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE\x30-\x39\x41-\x46\x61-\x66])};
${Char::Ekps9566::eb}          = qr{(?:\A(?=[0-9A-Z_a-z])|(?<=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF])(?=[0-9A-Z_a-z])|(?<=[0-9A-Z_a-z])(?=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF]|\z))};
${Char::Ekps9566::eB}          = qr{(?:(?<=[0-9A-Z_a-z])(?=[0-9A-Z_a-z])|(?<=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF])(?=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF]))};

# avoid: Name "Char::Ekps9566::foo" used only once: possible typo at here.
${Char::Ekps9566::dot}         = ${Char::Ekps9566::dot};
${Char::Ekps9566::dot_s}       = ${Char::Ekps9566::dot_s};
${Char::Ekps9566::eD}          = ${Char::Ekps9566::eD};
${Char::Ekps9566::eS}          = ${Char::Ekps9566::eS};
${Char::Ekps9566::eW}          = ${Char::Ekps9566::eW};
${Char::Ekps9566::eH}          = ${Char::Ekps9566::eH};
${Char::Ekps9566::eV}          = ${Char::Ekps9566::eV};
${Char::Ekps9566::eR}          = ${Char::Ekps9566::eR};
${Char::Ekps9566::eN}          = ${Char::Ekps9566::eN};
${Char::Ekps9566::not_alnum}   = ${Char::Ekps9566::not_alnum};
${Char::Ekps9566::not_alpha}   = ${Char::Ekps9566::not_alpha};
${Char::Ekps9566::not_ascii}   = ${Char::Ekps9566::not_ascii};
${Char::Ekps9566::not_blank}   = ${Char::Ekps9566::not_blank};
${Char::Ekps9566::not_cntrl}   = ${Char::Ekps9566::not_cntrl};
${Char::Ekps9566::not_digit}   = ${Char::Ekps9566::not_digit};
${Char::Ekps9566::not_graph}   = ${Char::Ekps9566::not_graph};
${Char::Ekps9566::not_lower}   = ${Char::Ekps9566::not_lower};
${Char::Ekps9566::not_lower_i} = ${Char::Ekps9566::not_lower_i};
${Char::Ekps9566::not_print}   = ${Char::Ekps9566::not_print};
${Char::Ekps9566::not_punct}   = ${Char::Ekps9566::not_punct};
${Char::Ekps9566::not_space}   = ${Char::Ekps9566::not_space};
${Char::Ekps9566::not_upper}   = ${Char::Ekps9566::not_upper};
${Char::Ekps9566::not_upper_i} = ${Char::Ekps9566::not_upper_i};
${Char::Ekps9566::not_word}    = ${Char::Ekps9566::not_word};
${Char::Ekps9566::not_xdigit}  = ${Char::Ekps9566::not_xdigit};
${Char::Ekps9566::eb}          = ${Char::Ekps9566::eb};
${Char::Ekps9566::eB}          = ${Char::Ekps9566::eB};
...
sub Char::Ekps9566::split(;$$$) {
    ...
    if (CORE::length($string) > 32766) {
        ...
        elsif (defined ${Char::Ekps9566::q_char_SADAHIRO_Tomoyuki_2002_01_17}) {
            $q_char = ${Char::Ekps9566::q_char_SADAHIRO_Tomoyuki_2002_01_17};
        }
    }
...
sub Char::Ekps9566::lcfirst(@) {
    if (@_) {
        my $s = shift @_;
        if (@_ and wantarray) {
            return Char::Ekps9566::lc(CORE::substr($s,0,1)) . CORE::substr($s,1), @_;
        }
        else {
            return Char::Ekps9566::lc(CORE::substr($s,0,1)) . CORE::substr($s,1);
        }
    }
    else {
        return Char::Ekps9566::lc(CORE::substr($_,0,1)) . CORE::substr($_,1);
    }
}
...
sub Char::Ekps9566::ucfirst(@) {
    if (@_) {
        my $s = shift @_;
        if (@_ and wantarray) {
            return Char::Ekps9566::uc(CORE::substr($s,0,1)) . CORE::substr($s,1), @_;
        }
        else {
            return Char::Ekps9566::uc(CORE::substr($s,0,1)) . CORE::substr($s,1);
        }
    }
    else {
        return Char::Ekps9566::uc(CORE::substr($_,0,1)) . CORE::substr($_,1);
    }
}
...
#
{
    ...
    sub Char::Ekps9566::matched() {
        $last_s_matched = 0;
    }

    # KPS9566 mark last s/// matched
    sub Char::Ekps9566::s_matched() {
        $last_s_matched = 1;
    }
    ...
    $Char::Ekps9566::matched = qr/(?{Char::Ekps9566::matched})/;
}
    ...
    for my $string (@string) {
        ...
        for (my $i=0; $i <= $#char; $i++) {
            ...
            # with /i modifier
                ...
                my $uc = Char::Ekps9566::uc($char[$i]);
                my $fc = Char::Ekps9566::fc($char[$i]);
                if ($uc ne $fc) {
                    if (CORE::length($fc) == 1) {
                        $char[$i] = '['   . $uc       . $fc . ']';
                    }
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # POSIX-style character classes
            ...
            $char[$i] = {
                ...
                '[:^lower:]'  => '${Char::Ekps9566::not_lower_i}',
                '[:^upper:]'  => '${Char::Ekps9566::not_upper_i}',
            ...
            $char[$i] = {
                ...
                '[:^alnum:]'  => '${Char::Ekps9566::not_alnum}',
                '[:^alpha:]'  => '${Char::Ekps9566::not_alpha}',
                '[:^ascii:]'  => '${Char::Ekps9566::not_ascii}',
                '[:^blank:]'  => '${Char::Ekps9566::not_blank}',
                '[:^cntrl:]'  => '${Char::Ekps9566::not_cntrl}',
                '[:^digit:]'  => '${Char::Ekps9566::not_digit}',
                '[:^graph:]'  => '${Char::Ekps9566::not_graph}',
                '[:^lower:]'  => '${Char::Ekps9566::not_lower}',
                '[:^print:]'  => '${Char::Ekps9566::not_print}',
                '[:^punct:]'  => '${Char::Ekps9566::not_punct}',
                '[:^space:]'  => '${Char::Ekps9566::not_space}',
                '[:^upper:]'  => '${Char::Ekps9566::not_upper}',
                '[:^word:]'   => '${Char::Ekps9566::not_word}',
                '[:^xdigit:]' => '${Char::Ekps9566::not_xdigit}',
            ...
            for (@singleoctet) {
                while (s/ \A \\x(..) - \\x(..) //oxms or s/ \A \\x((..)) //oxms) {
                    for my $ord (hex($1) .. hex($2)) {
                        ...
                        my $uc = Char::Ekps9566::uc($char);
                        my $fc = Char::Ekps9566::fc($char);
                        if ($uc eq $fc) {
...
sub Char::Ekps9566::filetest {
    ...
    unless (CORE::eval qq{Char::Ekps9566::$filetest(\$file)}) {
        return '';
    }
...
sub Char::Ekps9566::r(;*@) {
    ...
    local $_ = shift if @_;
    croak 'Too many arguments for -r (Char::Ekps9566::r)' if @_ and not wantarray;
    ...
    # (and so on)
        ...
        if (-d "$_/.") {
            ...
            # Even if ${^WIN32_SLOPPY_STAT} is set to a true value, Char::Ekps9566::*()
...
sub Char::Ekps9566::w(;*@) {
    ...
    local $_ = shift if @_;
    croak 'Too many arguments for -w (Char::Ekps9566::w)' if @_ and not wantarray;
...
sub Char::Ekps9566::x(;*@) {
    ...
    local $_ = shift if @_;
    croak 'Too many arguments for -x (Char::Ekps9566::x)' if @_ and not wantarray;
...
sub Char::Ekps9566::o(;*@) {
    ...
    local $_ = shift if @_;
    croak 'Too many arguments for -o (Char::Ekps9566::o)' if @_ and not wantarray;
...
sub Char::Ekps9566::e(;*@) {
    ...
    local $_ = shift if @_;
    croak 'Too many arguments for -e (Char::Ekps9566::e)' if @_ and not wantarray;
    ...
    elsif (defined Char::Ekps9566::telldir($fh)) {
        return wantarray ? ('',@_) : '';
    }
...
sub Char::Ekps9566::z(;*@) {
    ...
    local $_ = shift if @_;
    croak 'Too many arguments for -z (Char::Ekps9566::z)' if @_ and not wantarray;
...
sub Char::Ekps9566::s(;*@) {
    ...
    local $_ = shift if @_;
    croak 'Too many arguments for -s (Char::Ekps9566::s)' if @_ and not wantarray;
...
sub Char::Ekps9566::f(;*@) {
    ...
    local $_ = shift if @_;
    croak 'Too many arguments for -f (Char::Ekps9566::f)' if @_ and not wantarray;
...
sub Char::Ekps9566::d(;*@) {
    ...
    local $_ = shift if @_;
    croak 'Too many arguments for -d (Char::Ekps9566::d)' if @_ and not wantarray;
...
sub Char::Ekps9566::l(;*@) {
    ...
    local $_ = shift if @_;
    croak 'Too many arguments for -l (Char::Ekps9566::l)' if @_ and not wantarray;
...
sub Char::Ekps9566::p(;*@) {
    ...
    local $_ = shift if @_;
    croak 'Too many arguments for -p (Char::Ekps9566::p)' if @_ and not wantarray;
...
sub Char::Ekps9566::b(;*@) {
    ...
    local $_ = shift if @_;
    croak 'Too many arguments for -b (Char::Ekps9566::b)' if @_ and not wantarray;
...
sub Char::Ekps9566::c(;*@) {
    ...
    local $_ = shift if @_;
    croak 'Too many arguments for -c (Char::Ekps9566::c)' if @_ and not wantarray;
...
sub Char::Ekps9566::u(;*@) {
    ...
    local $_ = shift if @_;
    croak 'Too many arguments for -u (Char::Ekps9566::u)' if @_ and not wantarray;
...
sub Char::Ekps9566::g(;*@) {
    ...
    local $_ = shift if @_;
    croak 'Too many arguments for -g (Char::Ekps9566::g)' if @_ and not wantarray;
...
sub Char::Ekps9566::k(;*@) {
    ...
    local $_ = shift if @_;
    croak 'Too many arguments for -k (Char::Ekps9566::k)' if @_ and not wantarray;
...
sub Char::Ekps9566::T(;*@) {
    ...
    #     croak 'Too many arguments for -T (Char::Ekps9566::T)';
    ...
    if (defined fileno $fh) {
        ...
        if (defined Char::Ekps9566::telldir($fh)) {
            return wantarray ? (undef,@_) : undef;
        }
...
sub Char::Ekps9566::M(;*@) {
    ...
    local $_ = shift if @_;
    croak 'Too many arguments for -M (Char::Ekps9566::M)' if @_ and not wantarray;
...
sub Char::Ekps9566::A(;*@) {
    ...
    local $_ = shift if @_;
    croak 'Too many arguments for -A (Char::Ekps9566::A)' if @_ and not wantarray;
...
sub Char::Ekps9566::filetest_ {
    ...
    unless (CORE::eval qq{Char::Ekps9566::${filetest}_}) {
        return '';
    }
    for my $filetest (CORE::reverse @_) {
        unless (CORE::eval qq{ $filetest _ }) {
...
OUTER:
    for my $expr (@expr) {
        ...
        if ($expr =~ /\A " ((?:$q_char)*) " \z/oxms) {
            $expr = $1;
            if ($cond eq 'd') {
                if (Char::Ekps9566::d $expr) {
                    push @glob, $expr;
                }
            }
            else {
                if (Char::Ekps9566::e $expr) {
                    push @glob, $expr;
                }
            }
            next OUTER;
        ...
        if ($expr !~ / \A (?:$q_char)*? [*?] /oxms) {
            ...
            $head .= $expr;
            if ($cond eq 'd') {
                if (Char::Ekps9566::d $head) {
                    push @glob, $head;
                }
            }
            else {
                if (Char::Ekps9566::e $head) {
                    push @glob, $head;
                }
            }
            next OUTER;
        }
        Char::Ekps9566::opendir(*DIR, $head) or next OUTER;
        my @leaf = readdir DIR;
        closedir DIR;
...
#               $pattern .= "(?:$your_char)",   # UNIX style
            ...
            elsif ((my $fc = Char::Ekps9566::fc($char)) ne $char) {
                $pattern .= $fc;
            }
            else {
        ...
        my $matchsub = sub { Char::Ekps9566::fc($_[0]) =~ /\A $pattern \z/xms };
...
INNER:
        for my $leaf (@leaf) {
            ...
            if ($cond eq 'd' and not Char::Ekps9566::d "$head$leaf") {
                next INNER;
            }
            ...
            if (Char::Ekps9566::index($leaf,'.') == -1 and   # if name does not have a dot in it *and*
                CORE::length($leaf) <= 8 and        # name is shorter than or equal to 8 chars *and*
                Char::Ekps9566::index($pattern,'\\.') != -1  # pattern has a dot.
            ) {
                if (&$matchsub("$leaf.")) {
                    push @matched, "$head$leaf";
                    next INNER;
...
sub my_home {
    ...
    if (defined $home and ! Char::Ekps9566::d($home)) {
        $home = undef;
    }
    return $home;
}
...
sub Char::Ekps9566::lstat(*) {
    ...
    if (-e $_) {
        ...
        # Even if ${^WIN32_SLOPPY_STAT} is set to a true value, Char::Ekps9566::lstat()
        # on Windows opens the file for the path which has 5c at end.
        # (and so on)
...
sub Char::Ekps9566::stat(*) {
    ...
    if (defined fileno $fh) {
        ...
        # Even if ${^WIN32_SLOPPY_STAT} is set to a true value, Char::Ekps9566::stat()
        # on Windows opens the file for the path which has 5c at end.
        # (and so on)
        ...
        # rejected idea ...
            ...
            if (($] =~ /^5\.006/oxms)                     and
                ...
                *{'Dyna'.'Loader::dl_install_xsub'}{'CODE'}->('_SetCurrentDirectoryA', unpack('L', pack 'P', $x86));
                ...
                if (Char::Ekps9566::fc($chdir) eq Char::Ekps9566::fc($dir)) {
                    return 1;
                }
                else {
                    return 0;
...
#   long filename form.
        ...
        if (qx{ver} =~ /\b(?:Windows NT|Windows 2000)\b/oms) {
            ...
            for my $dirx (sort { CORE::length($a) <=> CORE::length($b) } @dirx) {
                if (Char::Ekps9566::fc(CORE::substr $dirx,-CORE::length($subdir[-1]),CORE::length($subdir[-1])) eq Char::Ekps9566::fc($subdir[-1])) {
        ...
        elsif (Char::Ekps9566::fc($shortdir) eq Char::Ekps9566::fc($dir)) {
            return 0;
        }
        return CORE::chdir $shortdir;
    }
...
ITER_DO:
    {
        for my $prefix (@INC) {
            ...
            if (Char::Ekps9566::f($realfilename)) {

                my $script = '';

                if (Char::Ekps9566::e("$realfilename.e")) {
                    my $e_mtime      = (Char::Ekps9566::stat("$realfilename.e"))[9];
                    my $mtime        = (Char::Ekps9566::stat($realfilename))[9];
                    my $module_mtime = (Char::Ekps9566::stat(__FILE__))[9];
                    if (($e_mtime < $mtime) or ($mtime < $module_mtime)) {
                        Char::Ekps9566::unlink "$realfilename.e";
                    }
                }
                ...
                if (Char::Ekps9566::e("$realfilename.e")) {
                    ...
                    if ($script =~ /^ \s* use \s+ Char::KPS9566 \s* ([^\x81-\xFE;]*) ; \s* \n? $/oxms) {
                        CORE::require Char::KPS9566;
                        $script = Char::KPS9566::escape_script($script);
                        my $fh = gensym();
...
sub Char::KPS9566::getc(;*@) {
    ...
    croak 'Too many arguments for Char::KPS9566::getc' if @_ and not wantarray;
    ...
    for my $length ($length[0] .. $length[-1]) {
        ...
        if (exists $range_tr{CORE::length($getc)}) {
            if ($getc =~ /\A ${Char::Ekps9566::dot_s} \z/oxms) {
...
sub Char::KPS9566::index($$;$) {
    ...
    my $index;
    if (@_ == 3) {
        $index = Char::Ekps9566::index($_[0], $_[1], CORE::length(Char::KPS9566::substr($_[0], 0, $_[2])));
    }
    else {
        $index = Char::Ekps9566::index($_[0], $_[1]);
    }
    ...
    if ($index == -1) {
        ...
        return Char::KPS9566::length(CORE::substr $_[0], 0, $index);
    }
}
...
sub Char::KPS9566::rindex($$;$) {
    ...
    my $rindex;
    if (@_ == 3) {
        $rindex = Char::Ekps9566::rindex($_[0], $_[1], CORE::length(Char::KPS9566::substr($_[0], 0, $_[2])));
    }
    else {
        $rindex = Char::Ekps9566::rindex($_[0], $_[1]);
    }
    ...
    if ($rindex == -1) {
        ...
        return Char::KPS9566::length(CORE::substr $_[0], 0, $rindex);
    }
}
...
my $qq_substr  = qr{(?: Char::KPS9566::substr | CORE::substr | substr ) \( $qq_paren \)
                 }xms;
...
my $matched     = '';
my $s_matched   = '';
$matched        = q{$Char::Ekps9566::matched};
$s_matched      = q{ Char::Ekps9566::s_matched();};
...
sub Char::KPS9566::escape(;$) {
    ...
    while (not /\G \z/oxgc) { # member
        $e_script .= Char::KPS9566::escape_token();
    }
...
# $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> Char::Ekps9566::PREMATCH()
    elsif (/\G ( \$` | \$\{`\} | \$ \s* PREMATCH  \b | \$ \s* \{ \s* PREMATCH  \s* \} | \$ \s* \{\^PREMATCH\}  ) /oxmsgc) {
        $slash = 'div';
        return q{Char::Ekps9566::PREMATCH()};
    }

# $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> Char::Ekps9566::MATCH()
    elsif (/\G ( \$& | \$\{&\} | \$ \s* MATCH     \b | \$ \s* \{ \s* MATCH     \s* \} | \$ \s* \{\^MATCH\}     ) /oxmsgc) {
        $slash = 'div';
        return q{Char::Ekps9566::MATCH()};
    }
...
# $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> Char::Ekps9566::POSTMATCH()
    elsif (/\G (                 \$ \s* POSTMATCH \b | \$ \s* \{ \s* POSTMATCH \s* \} | \$ \s* \{\^POSTMATCH\} ) /oxmsgc) {
        $slash = 'div';
        return q{Char::Ekps9566::POSTMATCH()};
    }
...
# while (<WILDCARD>) --- glob
    ...
    # avoid "Error: Runtime exception" of perl version 5.005_03
        ...
        return 'while ($_ = Char::Ekps9566::glob("' . $1 . '"))';
    }

# while (glob)
    elsif (/\G \b while \s* \( \s* glob \s* \) /oxgc) {
        return 'while ($_ = Char::Ekps9566::glob_)';
    }

# while (glob(WILDCARD))
    elsif (/\G \b while \s* \( \s* glob \b /oxgc) {
        return 'while ($_ = Char::Ekps9566::glob';
    }
...
# subroutines of package Char::Ekps9566
    elsif (/\G \b (CORE:: | ->[ ]* (?: atan2 | [a-z]{2,})) \b  /oxgc) { $slash = 'm//'; return $1;                  }
    elsif (/\G \b Char::KPS9566::eval       (?= \s* \{ )                /oxgc) { $slash = 'm//'; return 'eval';              }
    elsif (/\G \b Char::KPS9566::eval    \b (?! \s* => )                /oxgc) { $slash = 'm//'; return 'eval Char::KPS9566::escape'; }
    elsif (/\G \b bytes::substr \b (?! \s* => )                /oxgc) { $slash = 'm//'; return 'substr';            }
    elsif (/\G \b chop \b          (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Ekps9566::chop';       }
    elsif (/\G \b bytes::index \b  (?! \s* => )                /oxgc) { $slash = 'm//'; return 'index';             }
    elsif (/\G \b Char::KPS9566::index \b   (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::KPS9566::index';       }
    elsif (/\G \b index \b         (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Ekps9566::index';      }
    elsif (/\G \b bytes::rindex \b (?! \s* => )                /oxgc) { $slash = 'm//'; return 'rindex';            }
    elsif (/\G \b Char::KPS9566::rindex \b  (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::KPS9566::rindex';      }
    elsif (/\G \b rindex \b        (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Ekps9566::rindex';     }
    elsif (/\G \b lc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Ekps9566::lc';         }
    elsif (/\G \b lcfirst (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Ekps9566::lcfirst';    }
    elsif (/\G \b uc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Ekps9566::uc';         }
    elsif (/\G \b ucfirst (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Ekps9566::ucfirst';    }
    elsif (/\G \b fc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Ekps9566::fc';         }
    ...
    # (and so on)
                                                         ...
                                                         \s* (\") ((?:$qq_char)+?)             (\") /oxgc) { $slash = 'm//'; return "Char::Ekps9566::filetest(qw($1)," . e_qq('',  $2,$4,$3) . ")"; }
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) qq \s* (\#) ((?:$qq_char)+?)             (\#) /oxgc) { $slash = 'm//'; return "Char::Ekps9566::filetest(qw($1)," . e_qq('qq',$2,$4,$3) . ")"; }
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) qq \s* (\() ((?:$qq_paren)+?)            (\)) /oxgc) { $slash = 'm//'; return "Char::Ekps9566::filetest(qw($1)," . e_qq('qq',$2,$4,$3) . ")"; }
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) qq \s* (\{) ((?:$qq_brace)+?)            (\}) /oxgc) { $slash = 'm//'; return "Char::Ekps9566::filetest(qw($1)," . e_qq('qq',$2,$4,$3) . ")"; }
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) qq \s* (\[) ((?:$qq_bracket)+?)          (\]) /oxgc) { $slash = 'm//'; return "Char::Ekps9566::filetest(qw($1)," . e_qq('qq',$2,$4,$3) . ")"; }
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) qq \s* (\<) ((?:$qq_angle)+?)            (\>) /oxgc) { $slash = 'm//'; return "Char::Ekps9566::filetest(qw($1)," . e_qq('qq',$2,$4,$3) . ")"; }
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) qq \s* (\S) ((?:$qq_char)+?)             (\2) /oxgc) { $slash = 'm//'; return "Char::Ekps9566::filetest(qw($1)," . e_qq('qq',$2,$4,$3) . ")"; }

    elsif (/\G (-[rwxoRWXOezfdlpSbcugkTB](?:\s+-[rwxoRWXOezfdlpSbcugkTB])+)
                                                         \s* (\') ((?:\\\'|\\\\|$q_char)+?)    (\') /oxgc) { $slash = 'm//'; return "Char::Ekps9566::filetest(qw($1)," . e_q ('',  $2,$4,$3) . ")"; }
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) q  \s* (\#) ((?:\\\#|\\\\|$q_char)+?)    (\#) /oxgc) { $slash = 'm//'; return "Char::Ekps9566::filetest(qw($1)," . e_q ('q', $2,$4,$3) . ")"; }
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) q  \s* (\() ((?:\\\)|\\\\|$q_paren)+?)   (\)) /oxgc) { $slash = 'm//'; return "Char::Ekps9566::filetest(qw($1)," . e_q ('q', $2,$4,$3) . ")"; }
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) q  \s* (\{) ((?:\\\}|\\\\|$q_brace)+?)   (\}) /oxgc) { $slash = 'm//'; return "Char::Ekps9566::filetest(qw($1)," . e_q ('q', $2,$4,$3) . ")"; }
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) q  \s* (\[) ((?:\\\]|\\\\|$q_bracket)+?) (\]) /oxgc) { $slash = 'm//'; return "Char::Ekps9566::filetest(qw($1)," . e_q ('q', $2,$4,$3) . ")"; }
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) q  \s* (\<) ((?:\\\>|\\\\|$q_angle)+?)   (\>) /oxgc) { $slash = 'm//'; return "Char::Ekps9566::filetest(qw($1)," . e_q ('q', $2,$4,$3) . ")"; }
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) q  \s* (\S) ((?:\\\2|\\\\|$q_char)+?)    (\2) /oxgc) { $slash = 'm//'; return "Char::Ekps9566::filetest(qw($1)," . e_q ('q', $2,$4,$3) . ")"; }

    elsif (/\G (-[rwxoRWXOezfdlpSbcugkTB](?:\s+-[rwxoRWXOezfdlpSbcugkTB])+) (\$ \w+(?: ::\w+)* (?: (?: ->)? (?: [\$\@\%\&\*]\* | \$\#\* | \( (?:$qq_paren)*? \) | [\@\%\*]? \{ (?:$qq_brace)+? \} | [\@\%]? \[ (?:$qq_bracket)+? \] ) )*) /oxgc)
                                                                                                           { $slash = 'm//'; return "Char::Ekps9566::filetest(qw($1),$2)"; }
    elsif (/\G (-[rwxoRWXOezfdlpSbcugkTB](?:\s+-[rwxoRWXOezfdlpSbcugkTB])+) \( ((?:$qq_paren)*?) \) /oxgc) { $slash = 'm//'; return "Char::Ekps9566::filetest(qw($1),$2)"; }
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) (?= [a-z]+)                                   /oxgc) { $slash = 'm//'; return "Char::Ekps9566::filetest qw($1),";    }
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) (\w+)                                         /oxgc) { $slash = 'm//'; return "Char::Ekps9566::filetest(qw($1),$2)"; }

    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+    \s* (\") ((?:$qq_char)+?)                (\") /oxgc) { $slash = 'm//'; return "Char::Ekps9566::$1(" . e_qq('',  $2,$4,$3) . ")"; }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ qq \s* (\#) ((?:$qq_char)+?)                (\#) /oxgc) { $slash = 'm//'; return "Char::Ekps9566::$1(" . e_qq('qq',$2,$4,$3) . ")"; }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ qq \s* (\() ((?:$qq_paren)+?)               (\)) /oxgc) { $slash = 'm//'; return "Char::Ekps9566::$1(" . e_qq('qq',$2,$4,$3) . ")"; }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ qq \s* (\{) ((?:$qq_brace)+?)               (\}) /oxgc) { $slash = 'm//'; return "Char::Ekps9566::$1(" . e_qq('qq',$2,$4,$3) . ")"; }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ qq \s* (\[) ((?:$qq_bracket)+?)             (\]) /oxgc) { $slash = 'm//'; return "Char::Ekps9566::$1(" . e_qq('qq',$2,$4,$3) . ")"; }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ qq \s* (\<) ((?:$qq_angle)+?)               (\>) /oxgc) { $slash = 'm//'; return "Char::Ekps9566::$1(" . e_qq('qq',$2,$4,$3) . ")"; }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ qq \s* (\S) ((?:$qq_char)+?)                (\2) /oxgc) { $slash = 'm//'; return "Char::Ekps9566::$1(" . e_qq('qq',$2,$4,$3) . ")"; }

    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+    \s* (\') ((?:\\\'|\\\\|$q_char)+?)       (\') /oxgc) { $slash = 'm//'; return "Char::Ekps9566::$1(" . e_q ('',  $2,$4,$3) . ")"; }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ q  \s* (\#) ((?:\\\#|\\\\|$q_char)+?)       (\#) /oxgc) { $slash = 'm//'; return "Char::Ekps9566::$1(" . e_q ('q', $2,$4,$3) . ")"; }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ q  \s* (\() ((?:\\\)|\\\\|$q_paren)+?)      (\)) /oxgc) { $slash = 'm//'; return "Char::Ekps9566::$1(" . e_q ('q', $2,$4,$3) . ")"; }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ q  \s* (\{) ((?:\\\}|\\\\|$q_brace)+?)      (\}) /oxgc) { $slash = 'm//'; return "Char::Ekps9566::$1(" . e_q ('q', $2,$4,$3) . ")"; }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ q  \s* (\[) ((?:\\\]|\\\\|$q_bracket)+?)    (\]) /oxgc) { $slash = 'm//'; return "Char::Ekps9566::$1(" . e_q ('q', $2,$4,$3) . ")"; }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ q  \s* (\<) ((?:\\\>|\\\\|$q_angle)+?)      (\>) /oxgc) { $slash = 'm//'; return "Char::Ekps9566::$1(" . e_q ('q', $2,$4,$3) . ")"; }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ q  \s* (\S) ((?:\\\2|\\\\|$q_char)+?)       (\2) /oxgc) { $slash = 'm//'; return "Char::Ekps9566::$1(" . e_q ('q', $2,$4,$3) . ")"; }

    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s* (\$ \w+(?: ::\w+)* (?: (?: ->)? (?: [\$\@\%\&\*]\* | \$\#\* | \( (?:$qq_paren)*? \) | [\@\%\*]? \{ (?:$qq_brace)+? \} | [\@\%]? \[ (?:$qq_bracket)+? \] ) )*) /oxgc)
                                                                                                           { $slash = 'm//'; return "Char::Ekps9566::$1($2)";             }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s* \( ((?:$qq_paren)*?) \)                          /oxgc) { $slash = 'm//'; return "Char::Ekps9566::$1($2)";             }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) (?= \s+ [a-z]+)                                      /oxgc) { $slash = 'm//'; return "Char::Ekps9566::$1";                 }
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ (\w+)                                            /oxgc) { $slash = 'm//'; return "Char::Ekps9566::$1(::"."$2)";        }
    elsif (/\G -(t)                            \s+ (\w+)                                            /oxgc) { $slash = 'm//'; return "-t $2";                     }
    elsif (/\G \b lstat         (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(])                                /oxgc) { $slash = 'm//'; return 'Char::Ekps9566::lstat';              }
    elsif (/\G \b stat          (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(])                                /oxgc) { $slash = 'm//'; return 'Char::Ekps9566::stat';               }
    ...
    elsif (/\G \b chr           (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Ekps9566::chr';               }
    elsif (/\G \b bytes::ord    (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'div'; return 'ord';                      }
    elsif (/\G \b ord           (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'div'; return $function_ord;              }
    elsif (/\G \b glob          (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Ekps9566::glob';              }
    elsif (/\G \b lc \b            (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Ekps9566::lc_';               }
    elsif (/\G \b lcfirst \b       (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Ekps9566::lcfirst_';          }
    elsif (/\G \b uc \b            (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Ekps9566::uc_';               }
    elsif (/\G \b ucfirst \b       (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Ekps9566::ucfirst_';          }
    elsif (/\G \b fc \b            (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Ekps9566::fc_';               }
    elsif (/\G \b lstat \b         (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Ekps9566::lstat_';            }
    elsif (/\G \b stat \b          (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Ekps9566::stat_';             }
    elsif (/\G    (-[rwxoRWXOezfdlpSbcugkTB](?:\s+-[rwxoRWXOezfdlpSbcugkTB])+)
                     \b            (?! \s* => )                      /oxgc) { $slash = 'm//'; return "Char::Ekps9566::filetest_(qw($1))"; }
    elsif (/\G    -([rwxoRWXOezsfdlpSbcugkTBMAC])
                     \b            (?! \s* => )                      /oxgc) { $slash = 'm//'; return "Char::Ekps9566::${1}_";             }
    ...
    elsif (/\G \b chr \b           (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Ekps9566::chr_';              }
    elsif (/\G \b bytes::ord \b    (?! \s* => )                      /oxgc) { $slash = 'div'; return 'ord';                      }
    elsif (/\G \b ord \b           (?! \s* => )                      /oxgc) { $slash = 'div'; return $function_ord_;             }
    elsif (/\G \b glob \b          (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Ekps9566::glob_';             }
    elsif (/\G \b reverse \b       (?! \s* => )                      /oxgc) { $slash = 'm//'; return $function_reverse;          }
    elsif (/\G \b getc \b          (?! \s* => )                      /oxgc) { $slash = 'm//'; return $function_getc;             }
    elsif (/\G \b opendir (\s* \( \s*) (?=[A-Za-z_])                 /oxgc) { $slash = 'm//'; return "Char::Ekps9566::opendir$1*";        }
    elsif (/\G \b opendir (\s+)        (?=[A-Za-z_])                 /oxgc) { $slash = 'm//'; return "Char::Ekps9566::opendir$1*";        }
    elsif (/\G \b unlink \b        (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Ekps9566::unlink';            }

# chdir
    elsif (/\G \b (chdir) \b       (?! \s* => ) /oxgc) {
        $slash = 'm//';

        my $e = 'Char::Ekps9566::chdir';
...
# end of split
        if    (/\G (?= [,;\)\}\]] )          /oxgc) { return 'Char::Ekps9566::split' . $e;                 }

# split scalar value
        elsif (/\G ( [\$\@\&\*] $qq_scalar ) /oxgc) { return 'Char::Ekps9566::split' . $e . e_string($1);  }

# split literal space
        elsif (/\G \b qq       (\#) [ ] (\#) /oxgc) { return 'Char::Ekps9566::split' . $e . qq  {qq$1 $2}; }
        elsif (/\G \b qq (\s*) (\() [ ] (\)) /oxgc) { return 'Char::Ekps9566::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq (\s*) (\{) [ ] (\}) /oxgc) { return 'Char::Ekps9566::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq (\s*) (\[) [ ] (\]) /oxgc) { return 'Char::Ekps9566::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq (\s*) (\<) [ ] (\>) /oxgc) { return 'Char::Ekps9566::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq (\s*) (\S) [ ] (\2) /oxgc) { return 'Char::Ekps9566::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b q        (\#) [ ] (\#) /oxgc) { return 'Char::Ekps9566::split' . $e . qq   {q$1 $2}; }
        elsif (/\G \b q  (\s*) (\() [ ] (\)) /oxgc) { return 'Char::Ekps9566::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  (\s*) (\{) [ ] (\}) /oxgc) { return 'Char::Ekps9566::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  (\s*) (\[) [ ] (\]) /oxgc) { return 'Char::Ekps9566::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  (\s*) (\<) [ ] (\>) /oxgc) { return 'Char::Ekps9566::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  (\s*) (\S) [ ] (\2) /oxgc) { return 'Char::Ekps9566::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G                ' [ ] '    /oxgc) { return 'Char::Ekps9566::split' . $e . qq     {' '};  }
        elsif (/\G                " [ ] "    /oxgc) { return 'Char::Ekps9566::split' . $e . qq     {" "};  }
...
# do
    ...
    elsif (/\G \b do (?= \s+ (?: q | qq | qx ) \b)                                    /oxmsgc) { return 'Char::Ekps9566::do';         }
    elsif (/\G \b do (?= \s+ \w+)                                                     /oxmsgc) { return 'do';                }
    elsif (/\G \b do (?= \s* \$ \w+ (?: ::\w+)* \( )                                  /oxmsgc) { return 'do';                }
    elsif (/\G \b do \b                                                               /oxmsgc) { return 'Char::Ekps9566::do';         }
...
# require else
    elsif (/\G \b require                                   \s* ;                     /oxmsgc) { return 'Char::Ekps9566::require;';   }
    elsif (/\G \b require \b                                                          /oxmsgc) { return 'Char::Ekps9566::require';    }
...
# $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> @{[Char::Ekps9566::PREMATCH()]}
            ...
            $e_string .= q{Char::Ekps9566::PREMATCH()};
            $slash = 'div';
        }

# $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> @{[Char::Ekps9566::MATCH()]}
        elsif ($string =~ /\G ( \$& | \$\{&\} | \$ \s* MATCH     \b | \$ \s* \{ \s* MATCH     \s* \} | \$ \s* \{\^MATCH\}     ) /oxmsgc) {
            $e_string .= q{Char::Ekps9566::MATCH()};
            $slash = 'div';
        }
...
# $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> @{[Char::Ekps9566::POSTMATCH()]}
            ...
            $e_string .= q{Char::Ekps9566::POSTMATCH()};
            $slash = 'div';
        }
...
# subroutines of package Char::Ekps9566
        ...
        elsif ($string =~ /\G \b Char::KPS9566::eval       (?= \s* \{ )                /oxgc) { $e_string .= 'eval';              $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::KPS9566::eval \b                                /oxgc) { $e_string .= 'eval Char::KPS9566::escape'; $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::substr \b                             /oxgc) { $e_string .= 'substr';            $slash = 'm//'; }
        elsif ($string =~ /\G \b chop \b                                      /oxgc) { $e_string .= 'Char::Ekps9566::chop';       $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::index \b                              /oxgc) { $e_string .= 'index';             $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::KPS9566::index \b                               /oxgc) { $e_string .= 'Char::KPS9566::index';       $slash = 'm//'; }
        elsif ($string =~ /\G \b index \b                                     /oxgc) { $e_string .= 'Char::Ekps9566::index';      $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::rindex \b                             /oxgc) { $e_string .= 'rindex';            $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::KPS9566::rindex \b                              /oxgc) { $e_string .= 'Char::KPS9566::rindex';      $slash = 'm//'; }
        elsif ($string =~ /\G \b rindex \b                                    /oxgc) { $e_string .= 'Char::Ekps9566::rindex';     $slash = 'm//'; }
        elsif ($string =~ /\G \b lc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Ekps9566::lc';         $slash = 'm//'; }
        elsif ($string =~ /\G \b lcfirst (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Ekps9566::lcfirst';    $slash = 'm//'; }
        elsif ($string =~ /\G \b uc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Ekps9566::uc';         $slash = 'm//'; }
        elsif ($string =~ /\G \b ucfirst (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Ekps9566::ucfirst';    $slash = 'm//'; }
        elsif ($string =~ /\G \b fc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Ekps9566::fc';         $slash = 'm//'; }
        elsif ($string =~ /\G (-[rwxoRWXOezfdlpSbcugkTB](?:\s+-[rwxoRWXOezfdlpSbcugkTB])+)
                                                                        \s* (\") ((?:$qq_char)+?)             (\") /oxgc) { $e_string .= "Char::Ekps9566::filetest(qw($1)," . e_qq('',  $2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) qq \s* (\#) ((?:$qq_char)+?)             (\#) /oxgc) { $e_string .= "Char::Ekps9566::filetest(qw($1)," . e_qq('qq',$2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) qq \s* (\() ((?:$qq_paren)+?)            (\)) /oxgc) { $e_string .= "Char::Ekps9566::filetest(qw($1)," . e_qq('qq',$2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) qq \s* (\{) ((?:$qq_brace)+?)            (\}) /oxgc) { $e_string .= "Char::Ekps9566::filetest(qw($1)," . e_qq('qq',$2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) qq \s* (\[) ((?:$qq_bracket)+?)          (\]) /oxgc) { $e_string .= "Char::Ekps9566::filetest(qw($1)," . e_qq('qq',$2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) qq \s* (\<) ((?:$qq_angle)+?)            (\>) /oxgc) { $e_string .= "Char::Ekps9566::filetest(qw($1)," . e_qq('qq',$2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) qq \s* (\S) ((?:$qq_char)+?)             (\2) /oxgc) { $e_string .= "Char::Ekps9566::filetest(qw($1)," . e_qq('qq',$2,$4,$3) . ")"; $slash = 'm//'; }

        elsif ($string =~ /\G (-[rwxoRWXOezfdlpSbcugkTB](?:\s+-[rwxoRWXOezfdlpSbcugkTB])+)
                                                                        \s* (\') ((?:\\\'|\\\\|$q_char)+?)    (\') /oxgc) { $e_string .= "Char::Ekps9566::filetest(qw($1)," . e_q ('',  $2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) q  \s* (\#) ((?:\\\#|\\\\|$q_char)+?)    (\#) /oxgc) { $e_string .= "Char::Ekps9566::filetest(qw($1)," . e_q ('q', $2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) q  \s* (\() ((?:\\\)|\\\\|$q_paren)+?)   (\)) /oxgc) { $e_string .= "Char::Ekps9566::filetest(qw($1)," . e_q ('q', $2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) q  \s* (\{) ((?:\\\}|\\\\|$q_brace)+?)   (\}) /oxgc) { $e_string .= "Char::Ekps9566::filetest(qw($1)," . e_q ('q', $2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) q  \s* (\[) ((?:\\\]|\\\\|$q_bracket)+?) (\]) /oxgc) { $e_string .= "Char::Ekps9566::filetest(qw($1)," . e_q ('q', $2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) q  \s* (\<) ((?:\\\>|\\\\|$q_angle)+?)   (\>) /oxgc) { $e_string .= "Char::Ekps9566::filetest(qw($1)," . e_q ('q', $2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) q  \s* (\S) ((?:\\\2|\\\\|$q_char)+?)    (\2) /oxgc) { $e_string .= "Char::Ekps9566::filetest(qw($1)," . e_q ('q', $2,$4,$3) . ")"; $slash = 'm//'; }

        elsif ($string =~ /\G (-[rwxoRWXOezfdlpSbcugkTB](?:\s+-[rwxoRWXOezfdlpSbcugkTB])+) (\$ \w+(?: ::\w+)* (?: (?: ->)? (?: [\$\@\%\&\*]\* | \$\#\* | \( (?:$qq_paren)*? \) | [\@\%\*]? \{ (?:$qq_brace)+? \} | [\@\%]? \[ (?:$qq_bracket)+? \] ) )*) /oxgc)
                                                                                                                          { $e_string .= "Char::Ekps9566::filetest(qw($1),$2)"; $slash = 'm//'; }
        elsif ($string =~ /\G (-[rwxoRWXOezfdlpSbcugkTB](?:\s+-[rwxoRWXOezfdlpSbcugkTB])+) \( ((?:$qq_paren)*?) \) /oxgc) { $e_string .= "Char::Ekps9566::filetest(qw($1),$2)"; $slash = 'm//'; }
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) (?= [a-z]+)                                   /oxgc) { $e_string .= "Char::Ekps9566::filetest qw($1),";    $slash = 'm//'; }
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) (\w+)                                         /oxgc) { $e_string .= "Char::Ekps9566::filetest(qw($1),$2)"; $slash = 'm//'; }

        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+    \s* (\") ((?:$qq_char)+?)                (\") /oxgc) { $e_string .= "Char::Ekps9566::$1(" . e_qq('',  $2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ qq \s* (\#) ((?:$qq_char)+?)                (\#) /oxgc) { $e_string .= "Char::Ekps9566::$1(" . e_qq('qq',$2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ qq \s* (\() ((?:$qq_paren)+?)               (\)) /oxgc) { $e_string .= "Char::Ekps9566::$1(" . e_qq('qq',$2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ qq \s* (\{) ((?:$qq_brace)+?)               (\}) /oxgc) { $e_string .= "Char::Ekps9566::$1(" . e_qq('qq',$2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ qq \s* (\[) ((?:$qq_bracket)+?)             (\]) /oxgc) { $e_string .= "Char::Ekps9566::$1(" . e_qq('qq',$2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ qq \s* (\<) ((?:$qq_angle)+?)               (\>) /oxgc) { $e_string .= "Char::Ekps9566::$1(" . e_qq('qq',$2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ qq \s* (\S) ((?:$qq_char)+?)                (\2) /oxgc) { $e_string .= "Char::Ekps9566::$1(" . e_qq('qq',$2,$4,$3) . ")"; $slash = 'm//'; }

        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+    \s* (\') ((?:\\\'|\\\\|$q_char)+?)       (\') /oxgc) { $e_string .= "Char::Ekps9566::$1(" . e_q ('',  $2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ q  \s* (\#) ((?:\\\#|\\\\|$q_char)+?)       (\#) /oxgc) { $e_string .= "Char::Ekps9566::$1(" . e_q ('q', $2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ q  \s* (\() ((?:\\\)|\\\\|$q_paren)+?)      (\)) /oxgc) { $e_string .= "Char::Ekps9566::$1(" . e_q ('q', $2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ q  \s* (\{) ((?:\\\}|\\\\|$q_brace)+?)      (\}) /oxgc) { $e_string .= "Char::Ekps9566::$1(" . e_q ('q', $2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ q  \s* (\[) ((?:\\\]|\\\\|$q_bracket)+?)    (\]) /oxgc) { $e_string .= "Char::Ekps9566::$1(" . e_q ('q', $2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ q  \s* (\<) ((?:\\\>|\\\\|$q_angle)+?)      (\>) /oxgc) { $e_string .= "Char::Ekps9566::$1(" . e_q ('q', $2,$4,$3) . ")"; $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ q  \s* (\S) ((?:\\\2|\\\\|$q_char)+?)       (\2) /oxgc) { $e_string .= "Char::Ekps9566::$1(" . e_q ('q', $2,$4,$3) . ")"; $slash = 'm//'; }

        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s* (\$ \w+(?: ::\w+)* (?: (?: ->)? (?: [\$\@\%\&\*]\* | \$\#\* | \( (?:$qq_paren)*? \) | [\@\%\*]? \{ (?:$qq_brace)+? \} | [\@\%]? \[ (?:$qq_bracket)+? \] ) )*) /oxgc)
                                                                                                                          { $e_string .= "Char::Ekps9566::$1($2)";      $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s* \( ((?:$qq_paren)*?) \)                          /oxgc) { $e_string .= "Char::Ekps9566::$1($2)";      $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) (?= \s+ [a-z]+)                                      /oxgc) { $e_string .= "Char::Ekps9566::$1";          $slash = 'm//'; }
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ (\w+)                                            /oxgc) { $e_string .= "Char::Ekps9566::$1(::"."$2)"; $slash = 'm//'; }
        elsif ($string =~ /\G -(t)                            \s+ (\w+)                                            /oxgc) { $e_string .= "-t $2";              $slash = 'm//'; }
        elsif ($string =~ /\G \b lstat         (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(])                                /oxgc) { $e_string .= 'Char::Ekps9566::lstat';       $slash = 'm//'; }
        elsif ($string =~ /\G \b stat          (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(])                                /oxgc) { $e_string .= 'Char::Ekps9566::stat';        $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b chr           (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Ekps9566::chr';               $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b glob          (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Ekps9566::glob';              $slash = 'm//'; }
        elsif ($string =~ /\G \b lc \b                                              /oxgc) { $e_string .= 'Char::Ekps9566::lc_';               $slash = 'm//'; }
        elsif ($string =~ /\G \b lcfirst \b                                         /oxgc) { $e_string .= 'Char::Ekps9566::lcfirst_';          $slash = 'm//'; }
        elsif ($string =~ /\G \b uc \b                                              /oxgc) { $e_string .= 'Char::Ekps9566::uc_';               $slash = 'm//'; }
        elsif ($string =~ /\G \b ucfirst \b                                         /oxgc) { $e_string .= 'Char::Ekps9566::ucfirst_';          $slash = 'm//'; }
        elsif ($string =~ /\G \b fc \b                                              /oxgc) { $e_string .= 'Char::Ekps9566::fc_';               $slash = 'm//'; }
        elsif ($string =~ /\G \b lstat \b                                           /oxgc) { $e_string .= 'Char::Ekps9566::lstat_';            $slash = 'm//'; }
        elsif ($string =~ /\G \b stat \b                                            /oxgc) { $e_string .= 'Char::Ekps9566::stat_';             $slash = 'm//'; }
        elsif ($string =~ /\G    (-[rwxoRWXOezfdlpSbcugkTB](?:\s+-[rwxoRWXOezfdlpSbcugkTB])+)
                                                                 \b                 /oxgc) { $e_string .= "Char::Ekps9566::filetest_(qw($1))"; $slash = 'm//'; }
        elsif ($string =~ /\G    -([rwxoRWXOezsfdlpSbcugkTBMAC]) \b                 /oxgc) { $e_string .= "Char::Ekps9566::${1}_";             $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b chr \b                                             /oxgc) { $e_string .= 'Char::Ekps9566::chr_';              $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::ord \b                                      /oxgc) { $e_string .= 'ord';                      $slash = 'div'; }
        elsif ($string =~ /\G \b ord \b                                             /oxgc) { $e_string .= $function_ord_;             $slash = 'div'; }
        elsif ($string =~ /\G \b glob \b                                            /oxgc) { $e_string .= 'Char::Ekps9566::glob_';             $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b opendir (\s* \( \s*) (?=[A-Za-z_])                 /oxgc) { $e_string .= "Char::Ekps9566::opendir$1*";        $slash = 'm//'; }
        elsif ($string =~ /\G \b opendir (\s+)        (?=[A-Za-z_])                 /oxgc) { $e_string .= "Char::Ekps9566::opendir$1*";        $slash = 'm//'; }
        elsif ($string =~ /\G \b unlink \b                                          /oxgc) { $e_string .= 'Char::Ekps9566::unlink';            $slash = 'm//'; }

# chdir
        elsif ($string =~ /\G \b (chdir) \b (?! \s* => ) /oxgc) {
            $slash = 'm//';

            $e_string .= 'Char::Ekps9566::chdir';
...
# end of split
            if    ($string =~ /\G (?= [,;\)\}\]] )          /oxgc) { return 'Char::Ekps9566::split' . $e;                                           }

# split scalar value
            elsif ($string =~ /\G ( [\$\@\&\*] $qq_scalar ) /oxgc) { $e_string .= 'Char::Ekps9566::split' . $e . e_string($1);  next E_STRING_LOOP; }

# split literal space
            elsif ($string =~ /\G \b qq       (\#) [ ] (\#) /oxgc) { $e_string .= 'Char::Ekps9566::split' . $e . qq  {qq$1 $2}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\() [ ] (\)) /oxgc) { $e_string .= 'Char::Ekps9566::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\{) [ ] (\}) /oxgc) { $e_string .= 'Char::Ekps9566::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\[) [ ] (\]) /oxgc) { $e_string .= 'Char::Ekps9566::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\<) [ ] (\>) /oxgc) { $e_string .= 'Char::Ekps9566::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\S) [ ] (\2) /oxgc) { $e_string .= 'Char::Ekps9566::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q        (\#) [ ] (\#) /oxgc) { $e_string .= 'Char::Ekps9566::split' . $e . qq   {q$1 $2}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\() [ ] (\)) /oxgc) { $e_string .= 'Char::Ekps9566::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\{) [ ] (\}) /oxgc) { $e_string .= 'Char::Ekps9566::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\[) [ ] (\]) /oxgc) { $e_string .= 'Char::Ekps9566::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\<) [ ] (\>) /oxgc) { $e_string .= 'Char::Ekps9566::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\S) [ ] (\2) /oxgc) { $e_string .= 'Char::Ekps9566::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G                ' [ ] '    /oxgc) { $e_string .= 'Char::Ekps9566::split' . $e . qq     {' '};  next E_STRING_LOOP; }
            elsif ($string =~ /\G                " [ ] "    /oxgc) { $e_string .= 'Char::Ekps9566::split' . $e . qq     {" "};  next E_STRING_LOOP; }
...
sub character_class {
    ...
    if ($char eq '.') {
        if ($modifier =~ /s/) {
            return '${Char::Ekps9566::dot_s}';
        }
        else {
            return '${Char::Ekps9566::dot}';
        }
    }
    else {
        return Char::Ekps9566::classic_character_class($char);
    }
}
...
sub e_capture {
    ...
    return join '', '${Char::Ekps9566::capture(', $_[0], ')}';
    return join '', '${',                $_[0],  '}';
}
...
sub e_tr {
    ...
    if ($modifier =~ tr/bB//d) {
        ...
        if ($variable eq '') {
            $e_tr = qq{Char::Ekps9566::tr(\$_,' =~ ',$charclass,$e$charclass2,'$modifier')};
        }
        else {
            $e_tr = qq{Char::Ekps9566::tr($variable,'$bind_operator',$charclass,$e$charclass2,'$modifier')};
        }
    }
...
sub e_qq {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # octal escape sequence
            ...
            $char[$i] = Char::Ekps9566::octchr($1);
        }

        # hexadecimal escape sequence
        elsif ($char[$i] =~ /\A \\x \{ ([0-9A-Fa-f]+) \} \z/oxms) {
            $char[$i] = Char::Ekps9566::hexchr($1);
        }
        ...
        # \u \l \U \L \F \Q \E
            ...
            $char[$i] = '@{[Char::Ekps9566::ucfirst qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\l') {
            $char[$i] = '@{[Char::Ekps9566::lcfirst qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\U') {
            $char[$i] = '@{[Char::Ekps9566::uc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\L') {
            $char[$i] = '@{[Char::Ekps9566::lc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\F') {
            $char[$i] = '@{[Char::Ekps9566::fc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\Q') {
...
sub e_qr {
    ...
    for (my $i=0; $i <= $#char; $i++) {
            ...
            while (1) {
                ...
                if ($char[$i] eq ']') {
                    ...
                    if (grep(/\A [\$\@]/oxms,@char[$left+1..$right-1]) >= 1) {
                        splice @char, $left, $right-$left+1, sprintf(q{@{[Char::Ekps9566::charlist_qr(%s,'%s')]}}, join(',', map {qq_stuff($delimiter,$end_delimiter,$_)} @char[$left+1..$right-1]), $modifier);
                    }
                    else {
                        splice @char, $left, $right-$left+1, Char::Ekps9566::charlist_qr(@char[$left+1..$right-1], $modifier);
                    }
        ...
        # open character class [^...]
            ...
            while (1) {
                ...
                if ($char[$i] eq ']') {
                    ...
                    # [^...]
                    if (grep(/\A [\$\@]/oxms,@char[$left+1..$right-1]) >= 1) {
                        splice @char, $left, $right-$left+1, sprintf(q{@{[Char::Ekps9566::charlist_not_qr(%s,'%s')]}}, join(',', map {qq_stuff($delimiter,$end_delimiter,$_)} @char[$left+1..$right-1]), $modifier);
                    }
                    else {
                        splice @char, $left, $right-$left+1, Char::Ekps9566::charlist_not_qr(@char[$left+1..$right-1], $modifier);
                    }
        ...
        # /i modifier
        elsif ($ignorecase and ($char[$i] =~ /\A [\x00-\xFF] \z/oxms) and (Char::Ekps9566::uc($char[$i]) ne Char::Ekps9566::fc($char[$i]))) {
            if (CORE::length(Char::Ekps9566::fc($char[$i])) == 1) {
                $char[$i] = '['   . Char::Ekps9566::uc($char[$i])       . Char::Ekps9566::fc($char[$i]) . ']';
            }
            else {
                $char[$i] = '(?:' . Char::Ekps9566::uc($char[$i]) . '|' . Char::Ekps9566::fc($char[$i]) . ')';
            }
        ...
        # $0 --> $0
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Ekps9566::ignorecase(' . $char[$i] . ')]}';
            }
        }
        elsif ($char[$i] =~ /\A \$ \{ \s* 0 \s* \} \z/oxms) {
            if ($ignorecase) {
        ...
        # $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> Char::Ekps9566::PREMATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Ekps9566::ignorecase(Char::Ekps9566::PREMATCH())]}';
            }
            else {
                $char[$i] = '@{[Char::Ekps9566::PREMATCH()]}';
            }
        ...
        # $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> Char::Ekps9566::MATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Ekps9566::ignorecase(Char::Ekps9566::MATCH())]}';
            }
            else {
                $char[$i] = '@{[Char::Ekps9566::MATCH()]}';
            }
        ...
        # $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> Char::Ekps9566::POSTMATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Ekps9566::ignorecase(Char::Ekps9566::POSTMATCH())]}';
            }
            else {
                $char[$i] = '@{[Char::Ekps9566::POSTMATCH()]}';
            }
...
sub e_sub {
    ...
    if ($r_modifier) {
        ...
        # s///gr with multibyte anchoring
            ...
            $sub = sprintf(
                #                              1                                              2   3                                 4   5
                q<CORE::eval{local $Char::KPS9566::re_t=%s; local $Char::KPS9566::re_a=''; while($Char::KPS9566::re_t =~ %s){%s local $^W=0; local $Char::KPS9566::re_r=%s; %s$Char::KPS9566::re_t="$Char::KPS9566::re_a${1}$Char::KPS9566::re_r$'"; pos($Char::KPS9566::re_t)=length "$Char::KPS9566::re_a${1}$Char::KPS9566::re_r"; $Char::KPS9566::re_a=substr($Char::KPS9566::re_t,0,pos($Char::KPS9566::re_t)); } return $Char::KPS9566::re_t}>,
                ...
                $s_matched,                                                      #  3
                $e_replacement,                                                  #  4
                '$Char::KPS9566::re_r=CORE::eval $Char::KPS9566::re_r; ' x $e_modifier,            #  5
            );
        }
        ...
        # s///gr without multibyte anchoring
            ...
            $sub = sprintf(
                #                              1                        2   3                                 4   5
                q<CORE::eval{local $Char::KPS9566::re_t=%s; while($Char::KPS9566::re_t =~ %s){%s local $^W=0; local $Char::KPS9566::re_r=%s; %s$Char::KPS9566::re_t="$`$Char::KPS9566::re_r$'"; pos($Char::KPS9566::re_t)=length "$`$Char::KPS9566::re_r"; } return $Char::KPS9566::re_t}>,
        ...
        # s///r
            ...
            $sub = sprintf(
                #  1     2                3                                 4   5  6                    7
                q<(%s =~ %s) ? CORE::eval{%s local $^W=0; local $Char::KPS9566::re_r=%s; %s"%s$Char::KPS9566::re_r$'" } : %s>,
    ...
    # without /r
        ...
        # s///g with multibyte anchoring
            ...
            $sub = sprintf(
                ...
                q<CORE::eval{local $Char::KPS9566::re_n=0; local $Char::KPS9566::re_a=''; while(%s =~ %s){%s local $^W=0; local $Char::KPS9566::re_r=%s; %s%s="$Char::KPS9566::re_a${1}$Char::KPS9566::re_r$'"; pos(%s)=length "$Char::KPS9566::re_a${1}$Char::KPS9566::re_r"; $Char::KPS9566::re_a=substr(%s,0,pos(%s)); $Char::KPS9566::re_n++} return %s$Char::KPS9566::re_n}>,
...
# (and so on)
        ...
        # s///g without multibyte anchoring
            ...
            $sub = sprintf(
                #                                       1     2   3                                 4   5 6                         7                                                 8
                q<CORE::eval{local $Char::KPS9566::re_n=0; while(%s =~ %s){%s local $^W=0; local $Char::KPS9566::re_r=%s; %s%s="$`$Char::KPS9566::re_r$'"; pos(%s)=length "$`$Char::KPS9566::re_r"; $Char::KPS9566::re_n++} return %s$Char::KPS9566::re_n}>,
        ...
        # s///
            ...
            $sub = sprintf(
                ...
                #  1 2 3                4                                 5   6 7   8
                q<(%s%s%s) ? CORE::eval{%s local $^W=0; local $Char::KPS9566::re_r=%s; %s%s="%s$Char::KPS9566::re_r$'"; 1 } : undef> :

                #  1 2 3                    4                                 5   6 7   8
                q<(%s%s%s) ? 1 : CORE::eval{%s local $^W=0; local $Char::KPS9566::re_r=%s; %s%s="%s$Char::KPS9566::re_r$'"; undef }>,
                ...
                $s_matched,                                                      #  4
                $e_replacement,                                                  #  5
                '$Char::KPS9566::re_r=CORE::eval $Char::KPS9566::re_r; ' x $e_modifier,            #  6
                $variable,                                                       #  7
                $prematch,                                                       #  8
            );
        }
...
sub e_chdir {
    ...
    if ($^W) {
        if (Char::Ekps9566::_MSWin32_5Cended_path($string)) {
            if ($] !~ /^5\.005/) {
                warn <<END;
...
sub e_split {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # ${ foo }
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Ekps9566::ignorecase(' . $1 . ')]}';
            }
        }
    ...
    $modifier =~ tr/i//d;
    if ($left_e > $right_e) {
        return join '', 'Char::Ekps9566::split', $ope, $delimiter, @char, '>]}' x ($left_e - $right_e), $end_delimiter, $modifier;
    }
    return     join '', 'Char::Ekps9566::split', $ope, $delimiter, @char,                               $end_delimiter, $modifier;
}
...
sub e_use_noimport {
    ...
    for my $realfilename (_realfilename($expr)) {
        ...
        if (Char::Ekps9566::_open_r($fh, $realfilename)) {
            local $/ = undef; # slurp mode
            my $script = <$fh>;
            close($fh) or die __FILE__, ": Can't close file: $realfilename";

            if ($script =~ /^ \s* use \s+ Char::KPS9566 \s* ([^\x81-\xFE;]*) ; \s* \n? $/oxms) {
                return qq<BEGIN { Char::Ekps9566::require '$expr'; }>;
            }
            last;
        }
    }
    ...
    for my $realfilename (_realfilename($expr)) {
        ...
        if (Char::Ekps9566::_open_r($fh, $realfilename)) {
            ...
            if ($script =~ /^ \s* use \s+ Char::KPS9566 \s* ([^\x81-\xFE;]*) ; \s* \n? $/oxms) {
                ...
                return qq[BEGIN { Char::Ekps9566::require '$expr'; $module->import() if $module->can('import'); }];
            }
            last;
        }
    }
...
sub e_no_noparam {
    ...
    for my $realfilename (_realfilename($expr)) {
        ...
        if (Char::Ekps9566::_open_r($fh, $realfilename)) {
            ...
            if ($script =~ /^ \s* use \s+ Char::KPS9566 \s* ([^\x81-\xFE;]*) ; \s* \n? $/oxms) {
                return qq[BEGIN { Char::Ekps9566::require '$expr'; $module->unimport() if $module->can('unimport'); }];
            }
            last;
        }
    }
...
sub e_use {
    ...
    for my $realfilename (_realfilename($expr)) {
        ...
        if (Char::Ekps9566::_open_r($fh, $realfilename)) {
            ...
            if ($script =~ /^ \s* use \s+ Char::KPS9566 \s* ([^\x81-\xFE;]*) ; \s* \n? $/oxms) {
                return qq[BEGIN { Char::Ekps9566::require '$expr'; $module->import($list) if $module->can('import'); }];
            }
            last;
        }
    }
...
sub e_no {
    ...
    for my $realfilename (_realfilename($expr)) {
        ...
        if (Char::Ekps9566::_open_r($fh, $realfilename)) {
            ...
            if ($script =~ /^ \s* use \s+ Char::KPS9566 \s* ([^\x81-\xFE;]*) ; \s* \n? $/oxms) {
                return qq[BEGIN { Char::Ekps9566::require '$expr'; $module->unimport($list) if $module->can('unimport'); }];
            }
            last;
        }
    }
...
=head1 SYNOPSIS
  ...
  use Char::Ekps9566;
    ...
    Char::Ekps9566::chop(...);
    Char::Ekps9566::index(...);
    Char::Ekps9566::rindex(...);
    Char::Ekps9566::lc(...);
    Char::Ekps9566::lc_;
    Char::Ekps9566::lcfirst(...);
    Char::Ekps9566::lcfirst_;
    Char::Ekps9566::uc(...);
    Char::Ekps9566::uc_;
    Char::Ekps9566::ucfirst(...);
    Char::Ekps9566::ucfirst_;
    Char::Ekps9566::fc(...);
    Char::Ekps9566::fc_;
    Char::Ekps9566::ignorecase(...);
    Char::Ekps9566::capture(...);
    Char::Ekps9566::chr(...);
    Char::Ekps9566::chr_;
    Char::Ekps9566::X ...;
    Char::Ekps9566::X_;
    ...
    Char::Ekps9566::glob_;
    Char::Ekps9566::lstat(...);
    Char::Ekps9566::lstat_;
    Char::Ekps9566::opendir(...);
    Char::Ekps9566::stat(...);
    Char::Ekps9566::stat_;
    Char::Ekps9566::unlink(...);
    Char::Ekps9566::chdir(...);
    Char::Ekps9566::do(...);
    Char::Ekps9566::require(...);
    Char::Ekps9566::telldir(...);

  # "no Char::Ekps9566;" not supported

=head1 ABSTRACT

This module has run-time routines for use Char::KPS9566 software automatically, you
do not have to use.
...
some bugs. Thus, if you happen to find a bug that's in Char::KPS9566 software and not
...
This Char::Ekps9566 module first appeared in ActivePerl Build 522 Built under
...
=item Split string
  ...
  @split = Char::Ekps9566::split(/pattern/,$string,$limit);
  @split = Char::Ekps9566::split(/pattern/,$string);
  @split = Char::Ekps9566::split(/pattern/);
  @split = Char::Ekps9566::split('',$string,$limit);
  @split = Char::Ekps9566::split('',$string);
  @split = Char::Ekps9566::split('');
  @split = Char::Ekps9566::split();
  @split = Char::Ekps9566::split;
  ...
  at all, Char::Ekps9566::split returns the original string as a single substring, If it
  ...
  @chars  = Char::Ekps9566::split(//,  $word);
  @fields = Char::Ekps9566::split(/:/, $line);
  @words  = Char::Ekps9566::split(" ", $paragraph);
  @lines  = Char::Ekps9566::split(/^/, $buffer);
  ...
  print join(":" => Char::Ekps9566::split(/ */, "hi there"));
  ...
  Char::Ekps9566::split's pattern is exempt from that wrinkle.)

  The $limit parameter splits only part of a string:

  my ($login, $passwd, $remainder) = Char::Ekps9566::split(/:/, $_, 3);
  ...
  splits on whitespace just as Char::Ekps9566::split with no arguments does. Thus,
  Char::Ekps9566::split(" ") can be used to emulate awk's default behavior. In contrast,
  Char::Ekps9566::split(/ /) will give you as many null initial fields as there are
  ...
  $string = join(" ", Char::Ekps9566::split(" ", $string));
  ...
  %head = ("FRONTSTUFF", Char::Ekps9566::split(/^(\S*?):\s*/m, $header));
  ...
  while (<>) {
      for my $word (Char::Ekps9566::split()) {
          $count{$word}++;
      }
  }

  The inverse of Char::Ekps9566::split is join, except that join can only join with the
...
=item Transliteration
  ...
  $tr = Char::Ekps9566::tr($variable,$bind_operator,$searchlist,$replacementlist,$modifier);
  $tr = Char::Ekps9566::tr($variable,$bind_operator,$searchlist,$replacementlist);
  ...
  print Char::Ekps9566::tr('bookkeeper','=~','boep','peob','r'); # prints 'peekkoobor'

=item Chop string

  $chop = Char::Ekps9566::chop(@list);
  $chop = Char::Ekps9566::chop();
  $chop = Char::Ekps9566::chop;

  This subroutine chops off the last character of a string variable and returns the
  character chopped. The Char::Ekps9566::chop subroutine is used primary to remove the newline
  ...
  since Char::Ekps9566::chop always shortens the string no matter what's there, and chomp
  is more selective. If no argument is given, the subroutine chops the $_ variable.

  You cannot Char::Ekps9566::chop a literal, only a variable. If you Char::Ekps9566::chop a list of
  variables, each string in the list is chopped:

  @lines = `cat myfile`;
  Char::Ekps9566::chop(@lines);

  You can Char::Ekps9566::chop anything that is an lvalue, including an assignment:

  Char::Ekps9566::chop($cwd = `pwd`);
  Char::Ekps9566::chop($answer = <STDIN>);

  This is different from:

  $answer = Char::Ekps9566::chop($tmp = <STDIN>); # WRONG

  which puts a newline into $answer because Char::Ekps9566::chop returns the character
  ...
  In the most general case, Char::Ekps9566::chop can be expressed using substr:

  $last_code = Char::Ekps9566::chop($var);
  $last_code = substr($var, -1, 1, ""); # same thing

  Once you understand this equivalence, you can use it to do bigger chops. To
  Char::Ekps9566::chop more than one character, use substr as an lvalue, assigning a null
  ...
  form of substr, creating something of a quintuple Char::Ekps9566::chop;
...
=item Index string
  ...
  $byte_pos = Char::Ekps9566::index($string,$substr,$byte_offset);
  $byte_pos = Char::Ekps9566::index($string,$substr);
  ...
  $byte_pos = -1;
  while (($byte_pos = Char::Ekps9566::index($string, $lookfor, $byte_pos)) > -1) {
...
=item Reverse index string
  ...
  $byte_pos = Char::Ekps9566::rindex($string,$substr,$byte_offset);
  $byte_pos = Char::Ekps9566::rindex($string,$substr);

  This subroutine works just like Char::Ekps9566::index except that it returns the byte
  position of the last occurrence of $substring in $string (a reverse Char::Ekps9566::index).
  ...
  while (($byte_pos = Char::KPS9566::rindex($string, $lookfor, $byte_pos)) >= 0) {
      print "Found at $byte_pos\n";
      $byte_pos--;
  }
...
=item Lower case string
  ...
  $lc = Char::Ekps9566::lc($string);
  $lc = Char::Ekps9566::lc_;
  ...
  You can use the Char::Ekps9566::fc subroutine for case-insensitive comparisons via Char::KPS9566
  software.

=item Lower case first character of string

  $lcfirst = Char::Ekps9566::lcfirst($string);
  $lcfirst = Char::Ekps9566::lcfirst_;
...
=item Upper case string
  ...
  $uc = Char::Ekps9566::uc($string);
  $uc = Char::Ekps9566::uc_;
  ...
  in interpolated strings. For titlecase, use Char::Ekps9566::ucfirst instead.
...
=item Upper case first character of string
  ...
  $ucfirst = Char::Ekps9566::ucfirst($string);
  $ucfirst = Char::Ekps9566::ucfirst_;
  ...
  $titlecase = Char::Ekps9566::ucfirst(substr($word,0,1)) . Char::Ekps9566::lc(substr($word,1));
  ...
  $do_not_use = Char::Ekps9566::ucfirst(Char::Ekps9566::lc($word));
...
=item Fold case string
  ...
  $fc = Char::Ekps9566::fc($string);
  $fc = Char::Ekps9566::fc_;

  New to Char::KPS9566 software, this subroutine returns the full Unicode-like casefold of
  ...
  Char::Ekps9566::fc($a) eq Char::Ekps9566::fc($b)

  The reliable way to compare string case-insensitively was with the /i pattern
  modifier, because Char::KPS9566 software has always used casefolding semantics for
...
=item Make ignore case string
  ...
  @ignorecase = Char::Ekps9566::ignorecase(@string);

  This subroutine is internal use to m/ /i, s/ / /i, split / /i, and qr/ /i.

=item Make capture number

  $capturenumber = Char::Ekps9566::capture($string);

  This subroutine is internal use to m/ /, s/ / /, split / /, and qr/ /.

=item Make character

  $chr = Char::Ekps9566::chr($code);
  $chr = Char::Ekps9566::chr_;

  This subroutine returns a programmer-visible character, character represented by
  that $code in the character set. For example, Char::Ekps9566::chr(65) is "A" in either
  ASCII or KPS9566, not Unicode. For the reverse of Char::Ekps9566::chr, use Char::KPS9566::ord.

=item File test subroutine Char::Ekps9566::X
  ...
  ------------------------------------------------------------------------------
  Char::Ekps9566::r(*), Char::Ekps9566::r_()   File or directory is readable by this (effective) user or group
  Char::Ekps9566::w(*), Char::Ekps9566::w_()   File or directory is writable by this (effective) user or group
  Char::Ekps9566::e(*), Char::Ekps9566::e_()   File or directory name exists
  Char::Ekps9566::x(*), Char::Ekps9566::x_()   File or directory is executable by this (effective) user or group
  Char::Ekps9566::z(*), Char::Ekps9566::z_()   File exists and has zero size (always false for directories)
  Char::Ekps9566::f(*), Char::Ekps9566::f_()   Entry is a plain file
  Char::Ekps9566::d(*), Char::Ekps9566::d_()   Entry is a directory
  ------------------------------------------------------------------------------
  ...
  Subroutine and Prototype   Meaning
  ------------------------------------------------------------------------------
  Char::Ekps9566::R(*), Char::Ekps9566::R_()   File or directory is readable by this real user or group
                             Same as Char::Ekps9566::r(*), Char::Ekps9566::r_() on MacOS
  Char::Ekps9566::W(*), Char::Ekps9566::W_()   File or directory is writable by this real user or group
                             Same as Char::Ekps9566::w(*), Char::Ekps9566::w_() on MacOS
  Char::Ekps9566::X(*), Char::Ekps9566::X_()   File or directory is executable by this real user or group
                             Same as Char::Ekps9566::x(*), Char::Ekps9566::x_() on MacOS
  Char::Ekps9566::l(*), Char::Ekps9566::l_()   Entry is a symbolic link
  Char::Ekps9566::S(*), Char::Ekps9566::S_()   Entry is a socket
  ------------------------------------------------------------------------------
  ...
  Subroutine and Prototype   Meaning
  ------------------------------------------------------------------------------
  Char::Ekps9566::o(*), Char::Ekps9566::o_()   File or directory is owned by this (effective) user
  Char::Ekps9566::O(*), Char::Ekps9566::O_()   File or directory is owned by this real user
  Char::Ekps9566::p(*), Char::Ekps9566::p_()   Entry is a named pipe (a "fifo")
  Char::Ekps9566::b(*), Char::Ekps9566::b_()   Entry is a block-special file (like a mountable disk)
  Char::Ekps9566::c(*), Char::Ekps9566::c_()   Entry is a character-special file (like an I/O device)
  Char::Ekps9566::u(*), Char::Ekps9566::u_()   File or directory is setuid
  Char::Ekps9566::g(*), Char::Ekps9566::g_()   File or directory is setgid
  Char::Ekps9566::k(*), Char::Ekps9566::k_()   File or directory has the sticky bit set
  ------------------------------------------------------------------------------
  ...
  The Char::Ekps9566::T, Char::Ekps9566::T_, Char::Ekps9566::B, and Char::Ekps9566::B_ work as follows. The first block
  ...
  \377 in the first block is considered a binary file. If Char::Ekps9566::T or Char::Ekps9566::B is
  used on a filehandle, the current input (standard I/O or "stdio") buffer is
  examined rather than the first block of the file. Both Char::Ekps9566::T and Char::Ekps9566::B
  return 1 as true on an empty file, or on a file at EOF (end-of-file) when testing
  a filehandle. Both Char::Ekps9566::T and Char::Ekps9566::B doesn't work when given the special
  filehandle consisting of a solitary underline. Because Char::Ekps9566::T has to read to
  do the test, you don't want to use Char::Ekps9566::T on special files that might hang or
  give you other kinds or grief. So on most occasions you'll want to test with a
  Char::Ekps9566::f first, as in:

  next unless Char::Ekps9566::f($file) && Char::Ekps9566::T($file);

  Available in MSWin32, MacOS, and UNIX-like systems
  ------------------------------------------------------------------------------
  Subroutine and Prototype   Meaning
  ------------------------------------------------------------------------------
  Char::Ekps9566::T(*), Char::Ekps9566::T_()   File looks like a "text" file
  Char::Ekps9566::B(*), Char::Ekps9566::B_()   File looks like a "binary" file
  ------------------------------------------------------------------------------

  File ages for Char::Ekps9566::M, Char::Ekps9566::M_, Char::Ekps9566::A, Char::Ekps9566::A_, Char::Ekps9566::C, and Char::Ekps9566::C_
  ...
  next unless Char::Ekps9566::M($file) > 0.5;     # files are older than 12 hours
  &newfile if Char::Ekps9566::M($file) < 0;       # file is newer than process
  &mailwarning if int(Char::Ekps9566::A_) == 90;  # file ($_) was accessed 90 days ago today

  Available in MSWin32, MacOS, and UNIX-like systems
  ------------------------------------------------------------------------------
  Subroutine and Prototype   Meaning
  ------------------------------------------------------------------------------
  Char::Ekps9566::M(*), Char::Ekps9566::M_()   Modification age (measured in days)
  Char::Ekps9566::A(*), Char::Ekps9566::A_()   Access age (measured in days)
                             Same as Char::Ekps9566::M(*), Char::Ekps9566::M_() on MacOS
  Char::Ekps9566::C(*), Char::Ekps9566::C_()   Inode-modification age (measured in days)
  ------------------------------------------------------------------------------

  The Char::Ekps9566::s, and Char::Ekps9566::s_ returns file size in bytes if succesful, or undef
  unless successful.
  ...
  Subroutine and Prototype   Meaning
  ------------------------------------------------------------------------------
  Char::Ekps9566::s(*), Char::Ekps9566::s_()   File or directory exists and has nonzero size
                             (the value is the size in bytes)
  ------------------------------------------------------------------------------

=item Filename expansion (globbing)

  @glob = Char::Ekps9566::glob($string);
  @glob = Char::Ekps9566::glob_;
  ...
  The Char::Ekps9566::glob subroutine grandfathers the use of whitespace to separate multiple
  ...
  @spacies = <"*e f*">;
  @spacies = Char::Ekps9566::glob('"*e f*"');
  @spacies = Char::Ekps9566::glob(q("*e f*"));

  If you had to get a variable through, you could do this:

  @spacies = Char::Ekps9566::glob("'*${var}e f*'");
  @spacies = Char::Ekps9566::glob(qq("*${var}e f*"));
...
=item Statistics about link
  ...
  @lstat = Char::Ekps9566::lstat($file);
  @lstat = Char::Ekps9566::lstat_;

  Like Char::Ekps9566::stat, returns information on file, except that if file is a symbolic
  link, Char::Ekps9566::lstat returns information about the link; Char::Ekps9566::stat returns
  information about the file pointed to by the link. If symbolic links are
  unimplemented on your system, a normal Char::Ekps9566::stat is done instead. If file is
...
=item Open directory handle
  ...
  $rc = Char::Ekps9566::opendir(DIR,$dir);
...
=item Statistics about file
  ...
  $stat = Char::Ekps9566::stat(FILEHANDLE);
  $stat = Char::Ekps9566::stat(DIRHANDLE);
  $stat = Char::Ekps9566::stat($expr);
  $stat = Char::Ekps9566::stat_;
  @stat = Char::Ekps9566::stat(FILEHANDLE);
  @stat = Char::Ekps9566::stat(DIRHANDLE);
  @stat = Char::Ekps9566::stat($expr);
  @stat = Char::Ekps9566::stat_;
  ...
  ($dev,$ino,$mode,$nlink,$uid,$gid,$rdev,$size,
      $atime,$mtime,$ctime,$blksize,$blocks) = Char::Ekps9566::stat($expr);
  ...
  If Char::Ekps9566::stat is passed the special filehandle consisting of an underline, no
  actual stat(2) is done, but the current contents of the stat structure from
  the last Char::Ekps9566::stat, Char::Ekps9566::lstat, or Char::Ekps9566::stat-based file test subroutine
  (such as Char::Ekps9566::r, Char::Ekps9566::w, and Char::Ekps9566::x) are returned.
  ...
  $mode = (Char::Ekps9566::stat($expr))[2];
...
=item Deletes a list of files.
  ...
  $unlink = Char::Ekps9566::unlink(@list);
  $unlink = Char::Ekps9566::unlink($file);
  $unlink = Char::Ekps9566::unlink;
...
=item Changes the working directory.
  ...
  $chdir = Char::Ekps9566::chdir($dirname);
  $chdir = Char::Ekps9566::chdir;
...
=item Do file
  ...
  Char::Ekps9566::do('stat.pl');

  is rather like: 

  scalar CORE::eval `cat stat.pl`;   # `type stat.pl` on Windows

  except that Char::Ekps9566::do is more efficient, more concise, keeps track of the current
  filename for error messages, searches all the directories listed in the @INC
  array, and updates %INC if the file is found.
  It also differs in that code evaluated with Char::Ekps9566::do FILE can not see lexicals in
  ...
  If Char::Ekps9566::do can't read the file, it returns undef and sets $! to the error. If 
  Char::Ekps9566::do can read the file but can't compile it, it returns undef and sets an
  ...
  with the use and require operators, which also Char::Ekps9566::do error checking and raise
  ...
  But Char::Ekps9566::do FILE is still useful for such things as reading program configuration
  files. Manual error checking can be done this way:

  # read in config files: system first, then user
  for $file ("/usr/share/proggie/defaults.rc", "$ENV{HOME}/.someprogrc") {
      unless ($return = Char::Ekps9566::do($file)) {
          warn "couldn't parse $file: $@" if $@;
          warn "couldn't Char::Ekps9566::do($file): $!" unless defined $return;
  ...
  Char::Ekps9566::do to reload that file. This is more tidily accomplished with Char::Ekps9566::do than
  with Char::Ekps9566::require.

=item Require file

  Char::Ekps9566::require($file);
  Char::Ekps9566::require();

  This subroutine asserts a dependency of some kind on its argument. If an argument is
  not supplied, $_ is used.

  Char::Ekps9566::require loads and executes the Perl code found in the separate file whose
  name is given by the $file. This is similar to using a Char::Ekps9566::do on a file, except
  that Char::Ekps9566::require checks to see whether the library file has been loaded already
  ...
  its cousins Char::Ekps9566::do, Char::Ekps9566::require knows how to search the include path stored
...
=item Current position of the readdir
  ...
  $telldir = Char::Ekps9566::telldir(DIRHANDLE);
