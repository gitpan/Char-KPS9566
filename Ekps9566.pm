...
=item Chop string
  ...
  character chopped. The Ekps9566::chop function is used primary to remove the newline
...
=item Reverse index string
  ...
  This function works just like Ekps9566::index except that it returns the byte
...
=item Lower case string
  ...
  You can use the Ekps9566::fc function for case-insensitive comparisons via KPS9566
  software.
...
=item Fold case string
  ...
  New to KPS9566 software, this function returns the full Unicode-like casefold of
...
=item File test function Ekps9566::X
...
=item Filename expansion (globbing)
  ...
  The Ekps9566::glob function grandfathers the use of whitespace to separate multiple
...
=item Statistics about file
  ...
  the last Ekps9566::stat, Ekps9566::lstat, or Ekps9566::stat-based file test function
