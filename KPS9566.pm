...
# subroutines of package Ekps9566
    ...
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+    \s* (\') ((?:\\\'|\\\\|$q_char)+?)       (\') /oxgc) { $slash = 'm//'; return "Ekps9566::$1(" . e_q ('',  $2,$4,$3) . ")"; }
...
# subroutines of package Ekps9566
        ...
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+    \s* (\') ((?:\\\'|\\\\|$q_char)+?)       (\') /oxgc) { $e_string .= "Ekps9566::$1(" . e_q ('',  $2,$4,$3) . ")"; $slash = 'm//'; }
